...
def admin_movies():
    ...
    form = MovieForm()
    return render_template('admin/movies.html', movies=movies, form=form)
...
def admin_add_movie():
    ...
    movies = Movie.query.all()        
    return render_template('admin/movies.html', form=form, adding=True)
...
def admin_edit_movie(movie_id):
    ...
    # If form submission fails or it's a GET request
    movies = Movie.query.all()
    return render_template('admin/movies.html', movies=movies, form=form, movie=movie, editing=True)
...
def admin_theaters():
    ...
    form = TheaterForm()
    return render_template('admin/theaters.html', theaters=theaters, form=form)
